...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<ul id="yw0">
<li><a target="_BLANK" href="https://sites.google.com/a/students.jkuat.ac.ke/jkuatstudents/">Past Papers &amp; Passlists</a></li>
</ul>	</div><!-- mainmenu -->
			<!-- breadcrumbs -->
...
if (isset($_POST['login'])) {
    ...
    $res= mysqli_query($server, "SELECT * FROM usersdetails WHERE email='$username' AND password='$password'") or 
    die(mysql_error());
    //check rows returned
    ...
    if($count<1)
    {
        echo "<div class='alert alert-block alert-danger'>
            ...
            <strong>Failed to log in.</strong>Wrong Username or password.<br/>
            <br/>
            </div>";
	...
	<div id="login-area">
		...
		<div class="form">
			...
			<div class="row">
				...
				<input placeholder="john.doe@students" name="username"  type="text" />		
			</div>

			<div class="row">
				<label class="required">Password <span class="required">*</span></label>				
				<input placeholder="ab123-1234/2013" name="password" type="password" />
							</div>

			<div class="row rememberMe">
				<input  type="hidden" value="0" name="LoginForm[rememberMe]" /><input name="LoginForm[rememberMe]"  value="1" type="checkbox" />				
				<label>Keep me signed in</label>				
			</div>  
			 
			<div class="row buttons">
				<input class="cupid-green" type="submit" name="login" value="Login" />			</div>
